        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-6 col-md-auto"><a href="<?php echo e(route('emoloyees.index')); ?>" class="nav-link">Employee List</a></li>
                </ul>
...
<?php /**PATH C:\Users\ASUS\framework\mod4\resources\views/profile.blade.php ENDPATH**/ ?>